...
class LoginPage4 extends Page {
	static url = "/Ej06_Selenium_4/login.html"
...
class FormularioClientes extends Page {
	static url = "/Ej06_Selenium_4/seguro/SVClientes?accion=verFormulario"
...
class _11_PaginaClientes_Spec extends GebSpec {
	...
	def setup(){
		...
		setBaseUrl("http://localhost:8080/Ej00_AplicacionWeb")
