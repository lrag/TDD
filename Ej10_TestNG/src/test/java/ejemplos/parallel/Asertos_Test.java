...
public class Asertos_Test {
	...
	public void test7() {
		...
		//AssertSame compara utilizando '==', compara LAS REFERENCIAS (Excepto para los wrappers)
		assertSame(c1, c2);	
	}
	...
	public void test9() throws Exception {
		System.out.println(Thread.currentThread().getName()+"-Test 9");
	...
	@Test
	public void test10() {
		System.out.println(Thread.currentThread().getName()+"-Test 10");
		String[] palabras1 = new String[] {"HELLO","DOCTOR","NAME","CONTINUE","YESTERDAY","TOMORROW"};
		String[] palabras2 = new String[] {"HELLO","DOCTOR","NAME","CONTINUE","YESTERDAY","TOMORROW"};
	...
	public void test11() {		
		...
		System.out.println(Thread.currentThread().getName()+"-Test 11");
	...
	void test12() {
		...
		System.out.println(Thread.currentThread().getName()+"-Test 12");		
	...
	public void test13() {
		...
		System.out.println(Thread.currentThread().getName()+"-Test 13");
