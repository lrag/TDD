...
public class IntegracionTest {
	...
	invocar el método que está marcado con @BeforeAll
	incovar el método que está marcado con @BeforeEach
	invocar el método marcado que @Test 
	incovar el método que está marcado con @AfterEach
	invocar el método que está marcado con @AfterAll
